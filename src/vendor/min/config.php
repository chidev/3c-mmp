 ...
 */
$min_cachePath = './tmp'; //preg_replace('/^\\d+;/', '', session_save_path());
 ...
 * E.g. '/home/accountname/public_html' or 'D:\\xampp\\htdocs'
 *
...
if (isset($_GET['g'])) {
		...
		case 'js-ketchup':
			...
			//$min_serveOptions['maxAge'] = 86400 * 7;
			break;
		case 'css-base': $min_serveOptions['contentTypeCharset'] = 'iso-8859-1';
			break;
		}
}
