...
$offsite = array(
	'tradeslive.com.php5-9.dfw1-2.websitetestlink.com',
	'static.tradeslive.com.php5-9.dfw1-2.websitetestlink.com',
	'clients.tradeslive.com.php5-9.dfw1-2.websitetestlink.com',
	'www.tradeslive.com.php5-9.dfw1-2.websitetestlink.com',
	@$_SERVER['HTTP_HOST'],
	'localhost',
	'dev.chitownweb.com',
	'clients.graphics.ms',
...
$PHPTHUMB_CONFIG['nooffsitelink_valid_domains'] = $offsite;                                   // This is the list of domains for which thumbnails are allowed to be created. The default value of the current domain should be fine in most cases, but if neccesary you can add more domains in here, in the format 'www.example.com'
